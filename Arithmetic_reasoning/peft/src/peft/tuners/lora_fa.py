...
class LorafaConfig(PeftConfig):
    ...
    #*******modified*************
    init: str = field(default = 'uniform', metadata={"help": "choose initialization way for FA: uniform/normal"})
    #*******modified************

    def __post_init__(self):
    #*********modified************
        self.peft_type = PeftType.LORAFA
    #**********modified********    
        ...
        for key in key_list:
            ...
            if target_module_found:
                ...
                if loaded_in_8bit and isinstance(target, bnb.nn.Linear8bitLt):
                    ...
                    #**********modified***********
                    new_module = Linear(target.in_features, target.out_features, bias=bias, init = self.peft_config.init, **kwargs)
                    #*********modified***********
    ...
    def reset_parameters(self):
        ...
        #**********modified*************
            if self.init == 'uniform':
                ...
                nn.init.normal_(self.lora_A.weight, mean=0, std=1)
                nn.init.zeros_(self.lora_B.weight)
        #*********modified**************
