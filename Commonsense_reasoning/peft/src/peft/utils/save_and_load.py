...
def get_peft_model_state_dict(model, state_dict=None):
    ...
    #*******************modified*************************************
    elif model.peft_config.peft_type == PeftType.SBORA:
        bias = model.peft_config.bias
        if bias == "none":
            to_return = {k: state_dict[k] for k in state_dict if "lora_" in k}
        elif bias == "all":
    ...
    elif model.peft_config.peft_type == PeftType.LORAFA:
...
#*********************modified******************************
    ...
    if model.peft_config.peft_type != PeftType.LORA and model.peft_config.peft_type != PeftType.BOTTLENECK and model.peft_config.peft_type != PeftType.DORA and model.peft_config.peft_type != PeftType.SBORA and model.peft_config.peft_type != PeftType.LORAFA:
#********************modified****************************        
