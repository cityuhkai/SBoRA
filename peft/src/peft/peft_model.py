...
#*******modified*************
from .tuners import LorafaModel, SboraModel
#*******modified*************
from .utils import (
    ...
    **Attributes**:
    ...
    def __init__(self, model, peft_config: PeftConfig):
        ...
        if isinstance(self.peft_config, PromptLearningConfig):
            ...
            #*************modified*************
            elif self.peft_config.peft_type == PeftType.LORAFA:
                self.base_model = LorafaModel(peft_config, model)
            elif self.peft_config.peft_type == PeftType.SBORA:
                self.base_model = SboraModel(peft_config, model)
            #************modified***************
    ...
    def from_pretrained(cls, model, model_id, **kwargs):
        ...
        if getattr(model, "hf_device_map", None) is not None:
            ...
            #*************modified******************
            if model.peft_config.peft_type == PeftType.LORA or model.peft_config.peft_type == PeftType.BOTTLENECK or model.peft_config.peft_type == PeftType.DORA or model.peft_config.peft_type == PeftType.LORAFA or model.peft_config.peft_type == PeftType.SBORA:
            #************modifide***************    
